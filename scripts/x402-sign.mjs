...
/**
 * x402 ERC-3009 signing script for Ordiscan API payments.
 *
 * Usage:
 *   node x402-sign.mjs sign <base64-x-payment-required-header>
...
if (command === "sign") {
  ...
  if (!base64Header) {
    log("Usage: node x402-sign.mjs sign <base64-x-payment-required-header>");
    process.exit(1);
  }
  ...
  log("Usage:");
  log("  node x402-sign.mjs sign <base64-x-payment-required-header>");
